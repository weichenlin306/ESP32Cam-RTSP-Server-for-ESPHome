...
CAMERAS = {
  ...
  "ESP32CAM_S3_EYE": 2,     # esp32cam_s3_eye_config
  "ESP32CAM_TTGO_T": 3,     # esp32cam_ttgo_t_config
}
...
CONFIG_SCHEMA = cv.Schema(
  {
    ...
    cv.Optional(CONF_CAMERA, default="ESP32CAM_S3_EYE"): cv.enum(CAMERAS, upper=True),
    cv.Optional(CONF_XCLK_FREQ_HZ, default=20000000): cv.int_range(min=10000000, max=20000000),
...
async def to_code(config):
  ...
  cg.add_build_flag("-DBOARD_HAS_PSRAM=1")
  cg.add_build_flag("-mfix-esp32-psram-cache-issue")
  cg.add_build_flag("-DCONFIG_SCCB_HARDWARE_I2C_DRIVER_NEW=1")
  cg.add_build_flag("-DCONFIG_SCCB_CLK_FREQ=100000")
  cg.add_build_flag("-DCONFIG_OV2640_SUPPORT=1")
