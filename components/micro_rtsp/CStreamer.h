...
public:
    ...
    u_short GetWidth() const { return m_width; }
    u_short GetHeight() const { return m_height; }
...
bool decodeJPEGfile(BufPtr *start, uint32_t *len, BufPtr *qtable0, BufPtr *qtable1, uint8_t *type = nullptr, uint16_t *width = nullptr, uint16_t *height = nullptr);
